...
namespace ReshitScheduler
{
    public partial class SelectParentsForSmsForm : BasePage
    {
        ...
        private void FillStudents()
        {
            ...
            {
                Panel pnlStudent = new Panel() { CssClass = "col-12 col-md-6 col-lg-4 col-xl-2 border rounded" };
                ...
                RadioButtonList rblParents = new RadioButtonList() { RepeatDirection = RepeatDirection.Vertical,RepeatLayout= RepeatLayout.Flow ,CssClass = "col-6",CellSpacing=3};
